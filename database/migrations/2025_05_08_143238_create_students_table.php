...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('students', function (Blueprint $table) {
            ...
            $table->text('health_status_description')->nullable();
            $table->enum('orphan_status', ['not_an_orphan', 'father_is_an_orphan', 'mother_is_an_orphan','both_mother_and_father_are_orphans'])->default('not_an_orphan');
