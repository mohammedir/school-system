    ...
    <div class="toolbar py-3 py-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">Account Overview</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-header cursor-pointer">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">@lang('admin.Profile Details')</h3>
                    </div>
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="account/settings.html" class="btn btn-sm btn-primary align-self-center">@lang('admin.Edit Profile')</a>
                    <!--end::Action-->
                </div>
                <!--begin::Card header-->
                <!--begin::Card body-->
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 fw-semibold text-muted">@lang('admin.Full Name')</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 fw-semibold text-muted">@lang('admin.Email')</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 fw-semibold text-muted">@lang('admin.Mobile number')
                            <span class="ms-1" data-bs-toggle="tooltip" title="@lang('admin.Phone number must be active')">
