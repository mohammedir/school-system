<script>
    ...
    $(document).ready(function () {
        ...
        var KTProjectsAddproject = function () {
            var form = document.querySelector('#kt_project_adoption');
            var form_notes = document.querySelector('#kt_modal_rejected_project_adoption_notes_form');
            ...
            var initAddproject = function () {
                ...
                validator = FormValidation.formValidation(
                    ...
                    {
                        fields: {
                            offers_start_date: { validators: { notEmpty: { message: '{{ __("admin.This field is required") }}' } } },
                            offers_end_date: { validators: { notEmpty: { message: '{{ __("admin.This field is required") }}' } } },
                ...
                const submitButton = element.querySelector('[data-kt-project-adoption-action="submit"]');
                        ...
                        validator.validate().then(function (status) {
                            if (status == 'Valid') {
                                ...
                                setTimeout(function () {
                                    ...
                                    const url = `{{url("/")}}/projects/project-adoption/${project_Id}`; // Build the correct URL
                                    ...
                                    fetch(url, {
                                        ...
                                        .then(async response => {
                                            ...
                                            if (response.ok && data.status === 'success') {
                                                Swal.fire({
                                                    text: "@lang('admin.The project was successfully approved')",
                                                    icon: "success",
                ...
                const submitnoteButton = element.querySelector('[data-kt-rejected-project-adoption-action="submit"]');
