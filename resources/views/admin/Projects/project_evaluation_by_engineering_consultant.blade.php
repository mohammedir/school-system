                ...
                <div class="card card-flush mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('projects.engineering_consultant_evaluation',$project->id) }}" class="form mt-15" id="kt_engineering_consultant_evaluation_project">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 fv-row">
                                    <label class="form-label required">@lang('admin.Engineering Description')</label>
                                    <textarea name="engineering_consultant_description" style="display: none;"></textarea>

                                    <div class="kt_docs_ckeditor_document_toolbar"></div>
                                    <div class="kt_docs_ckeditor_document border-secondary" style="border-color: #6c757d !important;">
                            ...
                            <div class="col-md-9 text-end">
                                <button data-land-id="{{ $land->id }}" type="submit" name="action" value="recommend_accept" class="btn btn-success" data-kt-project-evaluation-engineering-consultant-action="submit">
                                    <span class="indicator-label"><i class="bi bi-check-circle"></i> @lang('admin.Recommend Accept')</span>
                                    <span class="indicator-progress">@lang('admin.Please wait...')
                                        <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                    </span>
                                </button>
                                <button type="button" class="btn btn-danger btn-outline me-5" data-bs-toggle="modal" data-bs-target="#kt_modal_no_need_edit"><i class="bi bi-x-circle"></i> @lang('admin.Recommend Reject')</button>
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" id="kt_modal_modify_price_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold">@lang('admin.Reasons for recommending rejection of the project')</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <div class="modal-body px-5 my-7">
                            <!--begin::Form-->
                            <form id="kt_modal_modify_engineering_consultant_decline_reasons_form" class="form"  method="post" action="{{ route('projects.engineering_consultant_evaluation', $project->id) }}"  enctype="multipart/form-data">
                                @csrf                                            <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_modify_price_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_modify_price_header" data-kt-scroll-wrappers="#kt_modal_modify_price_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <div class="input-group">
                                            <textarea rows="3" class="form-control" name="engineering_consultant_decline_reasons" style="text-align: right; direction: rtl;"></textarea>
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                ...
                                <div class="text-center pt-10">
                                    ...
                                    <button type="submit" class="btn btn-primary" value="engineering_consultant_decline_reasons"  data-kt-project-evaluation-engineering-consultant-notes-action="submit">
