                ...
                <form id="kt_form_award_offer" method="POST" action="javascript:;">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="row mb-4">
                            ...
                            @else
                                <h6 class="mt-5 text-center text-primary">@lang('admin.There are no attachments.')</h6>
                            @endif
                        ...
                        <div class="mb-4">
                            <div class="fv-row mb-8">
                                ...
                                <!--begin::Email-->
                                <div class="form-control bg-light" rows="4">{{ $project->awarded_engineering_reasons }} </div>
