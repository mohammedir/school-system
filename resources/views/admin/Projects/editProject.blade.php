    ...
    <div class="toolbar py-3 py-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">@lang('admin.Edit project')</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">@lang('admin.Edit project')</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <form method="POST" action="{{ route('projects.update', $project->id) }}" class="form" id="kt_add_project">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select id="land_id" name="land_id" aria-label="Select a Language" data-control="select2" data-placeholder="@lang('admin.Land details')" class="form-select mb-2">
                                    ...
                                    @foreach($lands as $land)
                                        <option  data-lat="{{$land->lat}}" data-long="{{$land->long}}" data-land_area="{{$land->area}}" data-investor_id="{{$land->investor_id}}" value="{{$land->id}}" @if($land->id == $project->lands->id) selected @endif>
                ...
                <div class="card card-flush mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-4 mb-15">
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{$project->project_logo != '' ? asset('/uploads/projects/' . $project->project_logo) : asset('assets/media/logos/logo_icon.png')}});"></div>
                        ...
                        <div class="row g-4 mb-15 fv-row">
                            <!--begin::Col-->
                            <div class="col-md-4">
                        ...
                        <div class="row g-4 mb-15">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <div id="area-error" class="text-danger mt-2 d-none">@lang('admin.Project area cannot exceed land area') <span id="land_area_note">{{ $project->lands->area }}</span>م2</div>
                                <!--begin::Hint-->
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <div class="input-group">
                                    <input value="{{$project->project_cost}}" class="form-control text-start number_format" id="project_cost" name="project_cost" type="text" placeholder="@lang('admin.Enter The project cost')">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-9 offset-md-3 text-end">
                                <button id="submit" type="submit" class="btn btn-info btn-outline me-5" data-kt-project-action="submit">
                                    ...
                                    <span class="indicator-progress">@lang('admin.Please wait...')<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                </button>
