...
@section('content')
    ...
    <div class="toolbar py-3 py-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">@lang('admin.View User Details')</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-column flex-lg-row-auto w-lg-250px w-xl-350px mb-10">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <div class="symbol symbol-100px symbol-circle mb-7">
                                    <img src="{{$user->avatar ? asset('uploads/usersImage/' . $user->avatar) : asset('assets/media/avatars/300-6.jpg')}}" alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="#" class="fs-3 text-gray-800 text-hover-info fw-bold mb-3">{{$user->name}}</a>
                                <!--end::Name-->
                                <!--begin::Position-->
                                <div class="mb-9">
                                    <!--begin::Badge-->
                                    <div class="badge badge-lg badge-light-info d-inline">{{ $user->getRoleNames()->join(', ') }}</div>
                                    <!--begin::Badge-->
                                </div>
                                <!--end::Position-->
                                <!--begin::Info-->
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                <div class="fw-bold rotate collapsible" data-bs-toggle="collapse" href="#kt_user_view_details" role="button" aria-expanded="false" aria-controls="kt_user_view_details">@lang('admin.Details')
                                    <span class="ms-2 rotate-180">
													<i class="ki-duotone ki-down fs-3"></i>
												</span></div>
                                @can('user edit')
                                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="@lang('admin.Edit customer details')">
													<a href="#" class="btn btn-sm btn-light-info" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">@lang('admin.Edit')</a>
												</span>
                                @endcan
                            </div>
                            <!--end::Details toggle-->
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">@lang('admin.Account ID')</div>
                                    <div class="text-gray-600">ID-{{$user->id}}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">@lang('admin.Email')</div>
                                    <div class="text-gray-600">
                                        <a href="#" class="text-gray-600 text-hover-info">{{$user->email}}</a>
                                    </div>
                                    <!--begin::Details item-->
                                </div>
                            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#" class="fs-5 text-gray-900 text-hover-info fw-bold">Google</a>
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#" class="fs-5 text-gray-900 text-hover-info fw-bold">Github</a>
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#" class="fs-5 text-gray-900 text-hover-info fw-bold">Slack</a>
                        ...
                        <div class="card-footer border-0 d-flex justify-content-center pt-0">
                            <button class="btn btn-sm btn-light-info">Save Changes</button>
                        </div>
                        <!--end::Card footer-->
                    </div>
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-info pb-4 active" data-bs-toggle="tab" href="#kt_user_view_overview_tab">Overview</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-info pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_view_overview_security">Security</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-info pb-4" data-bs-toggle="tab" href="#kt_user_view_overview_events_and_logs_tab">Events & Logs</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item ms-auto">
                            ...
                            <!--begin::Menu-->
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-info fw-semibold py-4 w-250px fs-6" data-kt-menu="true">
                                <!--begin::Menu item-->
                        ...
                        <div class="tab-pane fade show active" id="kt_user_view_overview_tab" role="tabpanel">
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <div class="card-toolbar">
                                        <button type="button" class="btn btn-light-info btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_add_schedule">
                                ...
                                <div class="card-body p-9 pt-4">
                                    ...
                                    <ul class="nav nav-pills d-flex flex-nowrap hover-scroll-x py-2">
                                        ...
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_0">
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info active" data-bs-toggle="tab" href="#kt_schedule_day_1">
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_2">
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_3">
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_4">
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_5">
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_6">
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_7">
                                                <span class="opacity-50 fs-7 fw-semibold">Su</span>
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_8">
                                                <span class="opacity-50 fs-7 fw-semibold">Mo</span>
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_9">
                                                <span class="opacity-50 fs-7 fw-semibold">Tu</span>
                                        ...
                                        <!--begin::Date-->
                                        <li class="nav-item me-1">
                                            <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-40px me-2 py-4 btn-active-info" data-bs-toggle="tab" href="#kt_schedule_day_10">
                                                <span class="opacity-50 fs-7 fw-semibold">We</span>
                                        ...
                                        <div id="kt_schedule_day_0" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Sales Pitch Proposal</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                ...
                                                <!--end::Info-->
                                                <!--begin::Action-->
                                                <a href="#" class="btn btn-light bnt-active-light-info btn-sm">View</a>
                                                <!--end::Action-->
                                            </div>
                                            <!--end::Time-->
                                            <!--begin::Time-->
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Project Review & Testing</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                                        <a href="#">Sean Bean</a></div>
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Committee Review Approvals</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                        ...
                                        <div id="kt_schedule_day_1" class="tab-pane fade show active">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Team Backlog Grooming Session</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                        ...
                                        <div id="kt_schedule_day_2" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">9 Degree Project Estimation Meeting</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Marketing Campaign Discussion</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                        ...
                                        <div id="kt_schedule_day_3" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Development Team Capacity Review</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                                        <a href="#">Sean Bean</a></div>
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Creative Content Initiative</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                                        <a href="#">David Stevenson</a></div>
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Dashboard UI/UX Design Review</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                        ...
                                        <div id="kt_schedule_day_4" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Weekly Team Stand-Up</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                                        <a href="#">David Stevenson</a></div>
                                        ...
                                        <div id="kt_schedule_day_5" class="tab-pane fade show">
                                            ...
                                            <div class="d-flex flex-stack position-relative mt-6">
                                                ...
                                                <div class="fw-semibold ms-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Title-->
                                                    <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info mb-2">Lunch & Learn Catch Up</a>
                                                    <!--end::Title-->
                                                    <!--begin::User-->
                                                    <div class="fs-7 text-muted">Lead by
                                                        <a href="#">Sean Bean</a></div>
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <!--begin::Card toolbar-->
                                    <div class="card-toolbar">
                                        <button type="button" class="btn btn-light-info btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_add_task">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info">Create FureStibe branding logo</a>
                                            <!--begin::Info-->
                                        ...
                                        <!--end::Details-->
                                        <!--begin::Menu-->
                                        <button type="button" class="btn btn-icon btn-active-light-info w-30px h-30px ms-auto" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" data-kt-menu-id="kt-users-tasks">
                                            ...
                                            <form class="form px-7 py-5" data-kt-menu-id="kt-users-tasks-form">
                                                ...
                                                <!--begin::Actions-->
                                                <div class="d-flex justify-content-end">
                                                    <button type="button" class="btn btn-sm btn-light btn-active-light-info me-2" data-kt-users-update-task-status="reset">Reset</button>
                                                    <button type="submit" class="btn btn-sm btn-info" data-kt-users-update-task-status="submit">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info">Schedule a meeting with FireBear CTO John</a>
                                            <!--begin::Info-->
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info">9 Degree Project Estimation</a>
                                            <!--begin::Info-->
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info">Dashboard UI & UX for Leafr CRM</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">Due in 1 week
                                    ...
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-info">Mivy App R&D, Meeting with clients</a>
                                            <!--begin::Info-->
                        ...
                        <div class="tab-pane fade" id="kt_user_view_overview_security" role="tabpanel">
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Add-->
                                        <button type="button" class="btn btn-light-info btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                        ...
                                        <!--begin::Menu-->
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-info fw-semibold fs-6 w-200px py-4" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#enable_auth_app_modal">Use authenticator app</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                ...
                                <div class="card-body pb-5">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex justify-content-end align-items-center">
                                            <!--begin::Button-->
                                            <button type="button" class="btn btn-icon btn-active-light-info w-30px h-30px ms-auto me-5" data-bs-toggle="modal" data-bs-target="#kt_modal_add_one_time_password">
                                            ...
                                            <!--end::Button-->
                                            <!--begin::Button-->
                                            <button type="button" class="btn btn-icon btn-active-light-info w-30px h-30px ms-auto" id="kt_users_delete_two_step">
                        ...
                        <div class="tab-pane fade" id="kt_user_view_overview_events_and_logs_tab" role="tabpanel">
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Filter-->
                                        <button type="button" class="btn btn-sm btn-flex btn-light-info" id="kt_modal_sign_out_sesions">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/invoices/in_5440_3472/payment</td>
                                                <td class="pe-0 text-end min-w-200px">20 Jun 2024, 8:43 pm</td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-70px">
                                                    <div class="badge badge-light-danger">500 ERR</div>
                                                </td>
                                                <td>POST /v1/invoice/in_1635_9488/invalid</td>
                                                <td class="pe-0 text-end min-w-200px">05 May 2024, 5:20 pm</td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-70px">
                                                    <div class="badge badge-light-success">200 OK</div>
                                                </td>
                                                <td>POST /v1/invoices/in_7261_8317/payment</td>
                                                <td class="pe-0 text-end min-w-200px">10 Mar 2024, 6:05 pm</td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-70px">
                                                    <div class="badge badge-light-success">200 OK</div>
                                                ...
                                                <td>POST /v1/invoices/in_5440_3472/payment</td>
                                                <td class="pe-0 text-end min-w-200px">20 Dec 2024, 6:05 pm</td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-70px">
                                                    <div class="badge badge-light-warning">404 WRN</div>
                                                </td>
                                                <td>POST /v1/customer/c_673c11bc5f56d/not_found</td>
                                                <td class="pe-0 text-end min-w-200px">21 Feb 2024, 8:43 pm</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        <!--end::Table-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
                                        ...
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#" class="text-gray-600 text-hover-info me-1">Sean Bean</a>has made payment to
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info">#XRS-45670</a></td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2024, 10:30 am</td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">Invoice
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info me-1">#KIO-45656</a>status has changed from
                                        ...
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#" class="text-gray-600 text-hover-info me-1">Sean Bean</a>has made payment to
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info">#XRS-45670</a></td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2024, 11:05 am</td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#" class="text-gray-600 text-hover-info me-1">Max Smith</a>has made payment to
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info">#SDK-45670</a></td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2024, 5:30 pm</td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#" class="text-gray-600 text-hover-info me-1">Max Smith</a>has made payment to
                                        ...
                                        <tr>
                                            <td class="min-w-400px">Invoice
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info me-1">#DER-45645</a>status has changed from
                                                <span class="badge badge-light-info me-1">In Progress</span>to
                                                <span class="badge badge-light-info">In Transit</span></td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2024, 11:30 am</td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">Invoice
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info me-1">#KIO-45656</a>status has changed from
                                                <span class="badge badge-light-succees me-1">In Transit</span>to
                                                <span class="badge badge-light-success">Approved</span></td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2024, 2:40 pm</td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#" class="text-gray-600 text-hover-info me-1">Brian Cox</a>has made payment to
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info">#OLP-45690</a></td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2024, 2:40 pm</td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                                <a href="#" class="text-gray-600 text-hover-info me-1">Sean Bean</a>has made payment to
                                        ...
                                        <tr>
                                            <td class="min-w-400px">Invoice
                                                <a href="#" class="fw-bold text-gray-900 text-hover-info me-1">#SEP-45656</a>status has changed from
                                                <span class="badge badge-light-warning me-1">Pending</span>to
                                                <span class="badge badge-light-info">In Progress</span></td>
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2024, 11:05 am</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <!--end::Table-->
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form" action="#" id="kt_modal_update_user_form">
                            ...
                            <div class="modal-header" id="kt_modal_update_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">@lang('admin.Update User Details')</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                    ...
                                    <input type="hidden" id="edit_user_id" name="user_id" value="{{$user->id}}">
                                        ...
                                        <div class="mb-7">
                                            ...
                                            <label class="fs-6 fw-semibold mb-2">
                                                <span>@lang('admin.Update Avatar')</span>
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <style>.image-input-placeholder { background-image: url('{{$user->avatar ? asset('uploads/usersImage/' . $user->avatar) : asset('assets/media/svg/avatars/blank-dark.svg')}}'); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url('{{$user->avatar ? asset('uploads/usersImage/' . $user->avatar) : 'assets/media/svg/avatars/blank-dark.svg'}}'); }</style>
                                                <!--end::Image placeholder-->
                                                <!--begin::Image input-->
                                                <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                    <!--begin::Preview existing avatar-->
                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{$user->avatar ? asset('uploads/usersImage/' . $user->avatar) : 'assets/media/svg/avatars/blank-dark.svg'}}')"></div>
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-semibold mb-2">@lang('admin.Full Name')</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" name="mobile_number" class="form-control form-control-solid mb-3 mb-lg-0" value="{{$user->mobile_number}}" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            ...
                                            @foreach($roles as $role)
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <!--begin::Input-->
                                                        <input class="form-check-input me-3" name="user_role" type="radio" value="{{$role->id}}" id="kt_modal_update_role_option_0" @if($user->getRoleNames()->join(', ') == $role->name) checked='checked' @endif />
                                                        <!--end::Input-->
                                                        <!--begin::Label-->
            ...
            <!--begin::Modal - Add task-->
            <div class="modal fade" id="enable_auth_app_modal" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <!--begin::Modal content-->
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div class="btn btn-icon btn-sm btn-active-icon-info" data-kt-add-auth-app-modal-action="close">
                                <i class="ki-duotone ki-cross fs-1">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                                </i>
                        ...
                        @if(!$is_authapp_enabled)
                            ...
                            <!--end::Content-->
                            <!--begin::Action-->
                             <h3 class="d-flex flex-center"> Or </h3> <br>

                            <div class="d-flex flex-center">
                                <div class="btn btn-light-info" data-kt-add-auth-action="text-code-button">Enter code manually</div>
                                <div class="btn btn-light-info d-none" data-kt-add-auth-action="qr-code-button">Scan barcode instead</div>
                            </div>
                            <!--end::Action-->
                            <form class="form" action="#" id="enable_auth_app_modal_form" method="POST">
                                <input type="hidden" id="user_id" name="user_id" value="{{$user->id}}">

                                <div class="fw-bold d-flex flex-column justify-content-center mt-5">
                                    <div class="text-center mb-5">2- Enter code shown in the Authenticator app.</div>
                                    ...
                                    <div class="fv-row mb-7 text-center">
                                        <input type="text" class="form-control form-control-solid text-center" name="otp_code"/>
                                            ...
                                            <div class="text-center pt-10">
                                                <button type="submit" class="btn btn-info me-5" data-kt-add-auth-app-modal-action="submit">
                                                    <span class="indicator-label"><i class="fa fa-lock"></i> Enable 2FA</span>
                                                    <span class="indicator-progress">@lang('admin.Please wait...')
																	<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                </button>
                                                <button type="reset" class="btn btn-secondary btn-outline" data-kt-add-auth-app-modal-action="cancel"><i class="bi bi-x-circle"></i> @lang('admin.Discard')</button>
                                            </div>
                                            <!--end::Actions-->
                            </form>  
                        @else
                            <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                                ...
                                <h3 class="d-flex flex-center"> Your authenticator app is Active</h3> <br>

                                <div class="d-flex flex-center mt-5">
                                    <form class="form" action="{{ route('users.disableAuthapp', $user->id) }}" method="GET">
                                        <button type="submit" class="btn btn-danger align-items-center"><i class="fa fa-lock"></i> Disable 2FA</button>  
                                    </form>   
                                </div>
                            </div>
                        @endif
...
@endsection
@section('js')
    @include('admin.UserManagement.Partial.users_view_js')
@endsection
