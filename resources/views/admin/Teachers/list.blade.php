    ...
    <div class="toolbar py-3 py-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">عرض المعلمين</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">إدارة المعلمين</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">عرض المعلمين</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_teacher">
                        <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            <th class="text-center min-w-125px">رقم هوية المدرس</th>
                            <th class="text-center min-w-125px">اسم المدرس</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">تغيير حالة المدرس</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">اسم المدرس</label>
                        <p class="fw-bold" id="teacherNameDisplay">-</p>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">الحالة الحالية</label>
                        <p><span class="badge" id="currentStatusBadge">-</span></p>
                    </div>

                    <div class="mb-3">
                        <label class="form-label required">الحالة الجديدة</label>
                        <div class="d-flex flex-column gap-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="new_status" id="status_active" value="active">
                                <label class="form-check-label" for="status_active">
                                    <span class="badge badge-success">مفعل</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="new_status" id="status_inactive" value="inactive">
                                <label class="form-check-label" for="status_inactive">
                                    <span class="badge badge-secondary">غير مفعل</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="new_status" id="status_suspended" value="suspended">
                                <label class="form-check-label" for="status_suspended">
                                    <span class="badge badge-danger">موقوف</span>
                                </label>
                            </div>
                        </div>
                        <div class="invalid-feedback" id="statusError">يرجى اختيار حالة جديدة</div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">إلغاء</button>
                    <button type="button" class="btn btn-primary" id="confirmChangeStatus">
                        <i class="fa fa-save me-2"></i>تغيير الحالة
                    </button>
                </div>
            </div>
        </div>
...
@endsection
@section('js')
    @include("admin.Teachers.Partial.teachers_list_js")
@endsection
