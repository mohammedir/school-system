    ...
    <div class="toolbar py-3 py-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">@lang('admin.General settings')</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">@lang('admin.General settings')</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary d-flex align-items-center pb-5" data-bs-toggle="tab" href="#kt_ecommerce_settings_localization">
                                <i class="ki-outline ki-compass fs-2 me-2"></i>Localization</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary d-flex align-items-center pb-5" data-bs-toggle="tab" href="#kt_ecommerce_settings_products">
                                <i class="ki-outline ki-package fs-2 me-2"></i>Products</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary d-flex align-items-center pb-5" data-bs-toggle="tab" href="#kt_ecommerce_settings_customers">
                                <i class="ki-outline ki-people fs-2 me-2"></i>Customers</a>
                        </li>
                        <!--end:::Tab item-->
                    </ul>
                    <!--end:::Tabs-->
                            ...
                            <form id="kt_ecommerce_settings_general_form" class="form" action="#">
                                ...
                                <div class="row mb-7">
                                    <div class="col-md-9 offset-md-3">
                                        <h2>@lang('admin.General Settings')</h2>
                                    </div>
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                <div class="row fv-row mb-7">
                                    <div class="col-md-3 text-md-end">
                                        ...
                                        <label class="fs-6 fw-semibold form-label mt-3">
                                            <span class="required">@lang('admin.Currency name')</span>
                                    ...
                                    <div class="col-md-9">
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" name="currency_name" value="{{$settings->currency_name}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <div class="row fv-row mb-7">
                                    <div class="col-md-3 text-md-end">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold form-label mt-3">
                                            <span class="required">@lang('admin.Currency symbol')</span>
                                            <span class="ms-1" data-bs-toggle="tooltip" title="Set the title of the store for SEO.">
																		<i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
																	</span>
                                        </label>
                                    ...
                                    <div class="col-md-9">
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" name="currency_symbol" value="{{$settings->currency_symbol}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group - Land Template Upload-->
                                <div class="row fv-row mb-7">
                                    <div class="col-md-3 text-md-end">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold form-label mt-3">
                                            <span>@lang('admin.Land Contract Template')</span>
                                            <span class="ms-1" data-bs-toggle="tooltip" title="@lang('admin.Upload the general land contract template (PDF/DOCX).')">
                                                <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                            </span>
                                        </label>
                                        <!--end::Label-->
                                    ...
                                    <div class="col-md-9">
                                        <!--begin::Input-->
                                        <input type="file" name="land_template_file" accept=".pdf,.doc,.docx" class="form-control form-control-solid" />
                                        <!--end::Input-->

                                        @if (!empty($settings->land_template_file))
                                            <!-- File already exists notice -->
                                            <div class="mt-2">
                                                <a href="{{ asset('uploads/settings/' . $settings->land_template_file) }}" target="_blank" class="text-primary fw-semibold">
                                                    <i class="fas fa-file-pdf me-1"></i> @lang('admin.Current file'): {{ $settings->land_template_file }}
                                                </a>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="row fv-row mb-7">
                                    <div class="col-md-3 text-md-end">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold form-label mt-3">
                                            <span>@lang('admin.Engineering Partner Contract Form')</span>
                                            <span class="ms-1" data-bs-toggle="tooltip" title="@lang('admin.Upload the general engineering contract template (PDF/DOCX).')">
                                                <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                            </span>
                                        </label>
                                        <!--end::Label-->
                                    ...
                                    <div class="col-md-9">
                                        <!--begin::Input-->
                                        <input type="file" name="engineering_template_file" accept=".pdf,.doc,.docx" class="form-control form-control-solid" />
                                        <!--end::Input-->

                                        @if (!empty($settings->engineering_template_file))
                                            <!-- File already exists notice -->
                                            <div class="mt-2">
                                                <a href="{{ asset('uploads/settings/' . $settings->engineering_template_file) }}" target="_blank" class="text-primary fw-semibold">
                                                    <i class="fas fa-file-pdf me-1"></i> @lang('admin.Current file'): {{ $settings->engineering_template_file }}
                                                </a>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="row fv-row mb-7">
                                    <div class="col-md-3 text-md-end">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold form-label mt-3">
                                            <span>@lang('admin.Contractors Contract Form')</span>
                                            <span class="ms-1" data-bs-toggle="tooltip" title="@lang('admin.Upload the general contractors contract template (PDF/DOCX).')">
                                                <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                            </span>
                                        </label>
                                        <!--end::Label-->
                                    ...
                                    <div class="col-md-9">
                                        <!--begin::Input-->
                                        <input type="file" name="contractor_template_file" accept=".pdf,.doc,.docx" class="form-control form-control-solid" />
                                        <!--end::Input-->

                                        @if (!empty($settings->contractor_template_file))
                                            <!-- File already exists notice -->
                                            <div class="mt-2">
                                                <a href="{{ asset('uploads/settings/' . $settings->contractor_template_file) }}" target="_blank" class="text-primary fw-semibold">
                                                    <i class="fas fa-file-pdf me-1"></i> @lang('admin.Current file'): {{ $settings->contractor_template_file }}
                                                </a>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="row py-5">
                                    <div class="col-md-9 offset-md-3">
                                        <div class="d-flex">
                                            <!--begin::Button-->
                                            <button type="reset" data-kt-ecommerce-settings-type="cancel" class="btn btn-light me-3">@lang('admin.Discard')</button>
                                            <!--end::Button-->
                                            <!--begin::Button-->
                                            <button type="submit" data-kt-ecommerce-settings-type="submit" class="btn btn-primary">
                                                <span class="indicator-label">@lang('admin.Save')</span>
...
@endsection
@section('js')
    @include("admin.SystemSettings.Partial.settings_js")
