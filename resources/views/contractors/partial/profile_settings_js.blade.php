...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const data_url = '{{ route('contractors.profile.update') }}';
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const data_url_password = '{{ route('contractors.profile.update-password') }}';
                    ...
                    validator.validate().then(function(status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            setTimeout(function() {
                                ...
                                const url =
                                    `{{ route('contractors.2fa.enableAuthapp') }}`; // Build the correct URL
