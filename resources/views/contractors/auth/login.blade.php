        ...
        <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
            ...
            <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                    <!--begin::Form-->
                    <form class="form w-100" method="POST" action="{{ route('contractors.login') }}" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ route('contractors.dashboardController') }}">
                        <!--begin::Heading-->
                        <img class="mb-10 text-center mx-auto d-block" src="{{asset('assets/media/logos/logo_icon.png')}}" height="150px"/>
                        <div class="text-center mb-11">
                            <!--begin::Title-->
                            <h1 class="text-gray-900 fw-bolder mb-3">@lang('admin.Contractor Portal') - @lang('admin.Sign in')</h1>
                            <!--end::Title-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group=-->
                        ...
                        <div class="text-gray-500 text-center fw-semibold fs-6">@lang('admin.Not a Member yet?')
                            <a href="{{route('contractors.register')}}" class="link-primary">@lang('admin.Sign up')</a></div>
                        <!--end::Sign up-->
                    </form>
                    <!--end::Form-->
                </div>
...
@include('contractors.auth.Partial.login_js')
