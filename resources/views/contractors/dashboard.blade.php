...
@section('content')
                    ...
                    @if(getContractorData(Auth::user()->id)->isPending())
                    <!--begin::Notice-->
                    ...
                    @if(getContractorData(Auth::user()->id)->isRejected())
                        <!--begin::Notice-->
                                ...
                                <div class="fw-semibold">
                                    ...
                                    @if(Auth::user()->rejection_reason)
                                        <div class="fs-6 text-danger">
                                            <strong>@lang('engineering.Rejection Reason'):</strong> {{ Auth::user()->rejection_reason }}
                                        </div>
                                    @endif
                                </div>
                                <!--end::Content-->
