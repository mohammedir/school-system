            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                ...
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <li class="breadcrumb-item text-gray-600">
                        <a href="{{route('contractors.dashboardController')}}" class="text-gray-600 text-hover-primary">@lang('engineering.home')</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ request()->routeIs('contractors.profile') ? 'active' : '' }}" href="{{route('contractors.profile')}}">@lang('engineering.Overview')</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ request()->routeIs('contractors.profile.settings') ? 'active' : '' }}" href="{{ route('contractors.profile.settings') }}">
                    ...
                    <div id="enable_auth_app_modal" class="d-none" data-kt-element="apps">
                        ...
                        @if(!$is_authapp_enabled)
                            ...
                            <div class="d-flex flex-center">
                                <div class="btn btn-light-info" data-kt-add-auth-action="text-code-button">@lang('admin.Enter code manually')</div>
                                <div class="btn btn-light-info d-none" data-kt-add-auth-action="qr-code-button">@lang('admin.Scan barcode instead')</div>
                            </div>
                            <!--end::Action-->
                            <form class="form" action="#" id="enable_auth_app_modal_form" data-kt-element="apps-form" method="POST">

                                <div class="fw-bold d-flex flex-column justify-content-center mt-5">
                                    <div class="text-center mb-5">2- @lang('admin.Enter code shown in the Authenticator app').</div>
                                    ...
                                    <div class="mb-10 fv-row">
                                        <input type="text" class="form-control form-control-lg form-control-solid text-center" placeholder="@lang('admin.Enter Code')" name="otp_code" />
                                    </div>
                                </div>
                                
                                            <!--begin::Actions-->
                                            <div class="text-center pt-10">
                                                <button type="submit" class="btn btn-primary me-5" data-kt-element="apps-submit" data-kt-add-auth-app-modal-action="submit">
                                                ...
                                                <button type="reset" data-kt-element="apps-cancel" class="btn btn-secondary btn-outline me-3"><i class="la la-redo"></i> @lang('admin.Back')</button>
                                            </div>
                                            <!--end::Actions-->
                            </form>  
                        @else
                            <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                                ...
                                <div class="d-flex flex-center mt-5">
                                    <form class="form" id="disable2faForm" action="{{ route('contractors.2fa.disableAuthapp') }}" method="GET">
                                        <button type="button" class="btn btn-danger align-items-center" onclick="confirmDisable()"><i class="fa fa-lock"></i> @lang('admin.Disable 2FA By Auth App')</button>  
                                    </form>   
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="d-none" data-kt-element="sms">
                        ...
                        <form data-kt-element="sms-form" class="form" action="#">
                            ...
                            <div class="d-flex flex-center">
                                ...
                                <button type="reset" data-kt-element="sms-cancel" class="btn btn-secondary btn-outline me-3"><i class="la la-redo"></i> @lang('admin.Back')</button>
                            </div>
                        </form>
                    </div>
                    <!--end::SMS-->
...
@include('contractors.partial.profile_settings_js')
