            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                ...
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <li class="breadcrumb-item text-gray-600">
                        <a href="{{route('engineering.dashboardController')}}" class="text-gray-600 text-hover-primary">@lang('engineering.home')</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ request()->routeIs('contractors.profile') ? 'active' : '' }}" href="#">@lang('engineering.Overview')</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
...
{{--                    @endif--}}
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 fw-semibold text-muted">@lang('engineering.Email')</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <span class="fw-bold fs-6 text-gray-800">{{$user->email}}</span>
                            @if($user->email_verified_at != null)
                                <span class="badge badge-success">@lang('admin.Verified')</span>                            
                            @else
                                <span class="badge badge-warning">@lang('admin.Not Verified')</span>
                            @endif                          
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 fw-semibold text-muted">@lang('engineering.Mobile')
                            <span class="ms-1" data-bs-toggle="tooltip" title="@lang('engineering.Mobile number must be active')">
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 fw-semibold text-muted">@lang('engineering.Contact Phone')</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
