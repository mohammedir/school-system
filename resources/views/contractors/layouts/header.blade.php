<div id="kt_app_header" class="app-header">
    ...
    <div class="app-header-brand ps-6">
        ...
        <!--end::Mobile toggle-->
        <!--begin::Logo-->
        <a class="app-sidebar-secondary-collapse-d-none text-center w-100" href="{{route('contractors.dashboardController')}}">
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5">
                            <a href="{{route('contractors.profile')}}" class="menu-link px-5">@lang('admin.My Profile')</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        <div class="separator my-2"></div>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ route('contractors.logout') }}" class="menu-link px-5"
                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="ki-outline ki-logout fs-2 me-2"></i>
                                @lang('admin.Sign Out')
                            </a>
                            <!-- الفورم المخفي لتنفيذ POST -->
                            <form id="logout-form" action="{{ route('contractors.logout') }}" method="POST" style="display: none;">
                                @csrf
                            </form>
                        </div>
                        <!--end::Menu item-->
