<script>
    $(document).ready(function () {
        let table = $("#kt_table_projects").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('contractors.my_projects.get_awardingApproved_offers') }}",
                data: function (d) {
            ...
            columns: [
                ...
                { data: 'project_type_cd', name: 'project.project_type_cd' },
                { data: 'area', name: 'project.area' },
                { data: 'project_cost', name: 'project.project_cost' },
        ...
        $(document).on('click', '.delete-btn', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Send delete request
                    fetch(`{{ route('engineering.engineering_offers.delete','') }}/${item_id}`, {
                        method: 'DELETE',
                        headers: {
