    ...
    <div class="toolbar py-3 py-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">@lang('contractors.Price offers')</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">
                        <a href="{{route('contractors.dashboardController')}}" class="text-gray-600 text-hover-primary">@lang('admin.dashboardController')</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">@lang('contractors.Price offers')</li>
                    <!--end::Item-->
                            ...
                            <div class="form-group row">
                                <div class="col-form-label col-lg-3 col-sm-6">
                                    ...
                                    <select id="status_cd" class="form-select" data-control="select2" name="status_cd">
                                        ...
                                        @foreach(get_lookup_by_master_key('contractor_offer_status') as $val)
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_projects">
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-center min-w-125px">@lang('contractors.Offered price')</th>
                            <th class="text-center min-w-125px">@lang('contractors.Implementation period')</th>
                            <th class="text-center min-w-125px">@lang('contractors.offer_date')</th>
                            <th class="text-center min-w-125px">@lang('contractors.status')</th>
...
@endsection
@section('js')
    @include("contractors.projects_management.Partial.offers_list_js")
@endsection
