            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                ...
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <li class="breadcrumb-item text-gray-600">
                        <a href="{{route('contractors.dashboardController')}}" class="text-gray-600 text-hover-info">@lang('admin.dashboardController')</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_projects">
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-center" width="40%">@lang('contractors.description')</th>
                            <th class="text-center min-w-125px">@lang('contractors.offers_start_date')</th>
                            <th class="text-center min-w-125px">@lang('contractors.offers_end_date')</th>
...
@endsection
@section('js')
    @include("contractors.projects_management.Partial.project_list_js")
@endsection
