    ...
    <div class="modal-dialog mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <form id="kt_form_contractor_award_offer" method="POST" action="javascript:;">
                    @csrf
                    <input type="hidden" name="offer_id" value="{{ $offer->id }}">
                    <input type="hidden" name="project_id" value="{{ $offer->project_id }}">
                    <!--begin::Heading-->
                    <div class="text-center mb-13">
                        <h1 class="mb-3">إعتماد ترسية العرض</h1>
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-light text-white" id="contractor_award_submit_btn" style="background-color: #EB6753">
