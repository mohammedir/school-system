                    ...
                    <div class="ps-widget bgc-white bdrs12 default-box-shadow2 pt30 mb30 overflow-hidden position-relative" >
                        <div class="navtab-style1">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <form action="{{  route('investors.dashboard.edit_land', ['land_id' => $land->id])   }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="mb20">
                                                        ...
                                                        <input  id="land_description" name="land_description" type="text" class="form-control" placeholder="@lang('admin.Enter land description here')" value="{{$land->land_description}}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-sm-4">
                                                    <label for="province_contractor" class="required">المحافظة</label>
                                                    <select id="province_cd" class="form-select form-control location_province" data-control="select2" name="province_cd" data-placeholder="@lang('engineering.select_province')" required>
                                                ...
                                                <div class="col-sm-4">
                                                    <label for="location_cities_contractor" class="required">المدينة</label>
                                                    <select class="form-select form-control location_city" name="city_cd" id="location_cities" data-control="select2" data-placeholder="@lang('engineering.select_city')" required>
                                                        <option value="" selected>@lang('lang.Select')..</option>
                                                        @foreach ($city as $val)
                                                ...
                                                <div class="col-sm-4">
                                                    <label for="location_areas_contractor" class="required">الحي</label>
                                                    <select class="form-select form-control" id="location_areas"  name="district_cd" data-control="select2" data-placeholder="@lang('engineering.select_district')" required>
                                                        <option value="" selected>@lang('lang.Select')..</option>
                                                        @foreach ($area as $val)
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="mb20">
                                                        ...
                                                        <textarea   name="address" cols="30" rows="3" required>{{$land->address}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mb20">
                                                        <label class="heading-color ff-heading fw600 mb10">@lang('admin.Border')</label>
                                                        <textarea  name="borders"  rows="3">{{$land->borders}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mb20">
                                                        <label class="heading-color ff-heading fw600 mb10">@lang('admin.Available services')</label>
                                                        <textarea  name="services"  rows="3">{{$land->services}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-xl-4">
                                                    <div class="mb30">
                                                        <label class="heading-color ff-heading fw600 mb10 required">@lang('admin.Land area')</label>
                                                        <input  name="area" type="text" class="form-control" placeholder="@lang('admin.Land area')" value="{{$land->area}}" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4 col-xl-4">
                                                    <div class="mb30">
                                                        <label class="heading-color ff-heading fw600 mb10">@lang('admin.Plot Number')</label>
                                                        <input  name="plot_number" type="text" class="form-control" placeholder="@lang('admin.Plot Number')" value="{{$land->plot_number}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4 col-xl-4">
                                                    <div class="mb30">
                                                        <label class="heading-color ff-heading fw600 mb10">@lang('admin.Parcel Number')</label>
                                                        <input  name="parcel_number" type="text" class="form-control" placeholder="@lang('admin.Parcel Number')" value="{{$land->parcel_number}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4 col-xl-4">
                                                    <div class="mb30">
                                                        <label class="heading-color ff-heading fw600 mb10 required">@lang('admin.Type of land ownership')</label>
                                                        <select required class="form-select form-control" name="ownership_type_cd" data-control="select2" data-placeholder="@lang('admin.Choose the land ownership type')">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        <input  value="{{$land->price}}" type="text" class="form-control number_format" name="price" placeholder="@lang('admin.Enter the price')" style="text-align: right; direction: rtl;" required>
                                    ...
                                    <div class="tab-pane fade" id="nav-item2" role="tabpanel" aria-labelledby="nav-item2-tab">
                                        <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                                            <div class="col-12" style="padding-bottom: 20px">
                                                ...
                                                <input type="file" id="main_land_images" class="form-control" name="land_logo"  accept="image/*" style="height: auto; padding-right: 2px">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 d-flex flex-column justify-content-center gap-3">
                                                    <div>
                                                        ...
                                                        <input type="text" id="lat" name="lat" class="form-control" placeholder="@lang('admin.Latitude')" value="{{ $land->lat ?? '31.5012' }}">
                                                    </div>
                                                    <div>
                                                        <label class="form-label fw-bold required">@lang('admin.Longitude')</label>
                                                        <input type="text" id="long" name="long" class="form-control" placeholder="@lang('admin.Longitude')" value="{{ $land->lat ?? '34.4663' }}">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                                            <div class="card card-flush mt-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div id="ownership-documents-container" style="padding-top: 10px">
                                            ...
                                            <div class="col-md-12 mt30">
                                                <div class="d-sm-flex justify-content-between">
                                                    <a class="ud-btn btn-dark next-tab" data-next-tab="#nav-item3" href="javascript:void(0)">
                                                         السابق<i class="fal fa-arrow-left-long"></i></a>
                                                    <button type="submit" class="ud-btn btn-thm">تعديل الأرض<i class="fal fa-arrow-right-long"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
