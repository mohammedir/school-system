                ...
                <div class="col-xxl-3">
                    ...
                    <div class="col-xxl-9">
                        <div class="dashboard_search_meta d-md-flex align-items-center justify-content-xxl-end">
                            <a href="{{route('investors.dashboard.add_land')}}" class="ud-btn btn-thm">إضافة أرض جديدة </a>
                        </div>
                    </div>
                    @endif
            </div>
                    ...
                    <div class="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                        <div class="packages_table table-responsive">
                            <table id="investor_table_my_land" class="table-style3 table at-savesearch">
                                <thead class="t-head">
                                <tr>
                                    <th scope="col">@lang('admin.Description of the land')</th>
                                    <th scope="col"> سعر الأرض</th>
                                    <th scope="col">@lang('admin.Real estate appraiser evaluation')</th>
                                    <th scope="col">@lang('admin.Evaluation of the legal partner')</th>
