                ...
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <li class="breadcrumb-item text-gray-600">
                        <a href="{{route('engineering.dashboardController')}}"
                           class="text-gray-600 text-hover-info">@lang('admin.dashboardController')</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                        ...
                        <form class="kt-form kt-form--label-right form-control" id="filters" method="GET"
                            ...
                            <div class="form-group row">
                                <div class="col-form-label col-lg-3 col-sm-6">
                                    ...
                                    <select id="project_type_cd" class="form-select" data-control="select2"
                                            name="project_type_cd">
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_projects">
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            <th class="text-center" width="20%">@lang('admin.Project name')</th>
                            <th class="text-center" width="40%">@lang('engineering.description')</th>
                            <th class="text-center min-w-125px">@lang('engineering.offers_start_date')</th>
                            <th class="text-center min-w-125px">@lang('engineering.offers_end_date')</th>
...
@endsection
@section('js')
    @include("teacher.projects_management.Partial.project_list_js")
@endsection
