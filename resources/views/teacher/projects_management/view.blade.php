                ...
                <div class="card-body">
                    ...
                    <div class="row g-4 mb-15">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="input-group">
                                <input disabled class="form-control text-start number_format" id="project_cost"
                                       value="{{$project->project_cost}}" name="project_cost" type="text"
                ...
                <div class="card card-flush mt-5">
                    ...
                    <div class="card-header pt-8">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center gap-2">
                                <!--begin::Input-->
                                <h3>@lang('engineering.Submit a quote')</h3>
                                <!--end::Input-->
                            </div>
                        </div>
                        <!--end::Col-->
