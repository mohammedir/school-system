        ...
        <div
            ...
            <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                    <!--begin::Form-->
                    <form class="form w-100" method="POST" action="{{ route('teachers.login') }}" novalidate="novalidate"
                          id="kt_sign_in_form" data-kt-redirect-url="{{ route('teachers.dashboard') }}">
                        <!--begin::Heading-->
                        <div class="text-center mb-11">
                            <img class="mb-10 text-center mx-auto d-block"
                                 src="{{asset('/uploads/logo/logo_dashbord.jpg')}}" height="150px">
                            <h1 class="text-gray-900 fw-bolder mb-3">بوابة المدرس - @lang('admin.Sign in')</h1>
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group=-->
                        <div class="fv-row mb-8">
                            <!--begin::Email-->
                            <input type="number" placeholder="رقم الجوال" name="phone_number" autocomplete="off"
                        ...
                        <div class="text-gray-500 text-center fw-semibold fs-6">@lang('admin.Not a Member yet?')
                            <a href="{{route('teachers.register')}}" class="link-primary">@lang('admin.Sign up')</a>
                        </div>
                        <!--end::Sign up-->
                    </form>
                    <!--end::Form-->
            ...
            <div class="d-flex flex-center flex-lg-start flex-column">
                ...
                <a href="index.html" class="mb-7">
                    ...
                    <img class=" mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                         src="{{asset('/uploads/logo/white_logo.png')}}" alt=""/>
...
@include('teacher.auth.Partial.login_js')
